"""
Use this  to modify the password (encryption key) 
   used by BPA BLECOnnect Router to encrypt bluetooth communications

Launch this file with sudo: 
(Asumming you installed in the default suggested directory: /usr/local/bluepieapps)

     sudo python3 /usr/local/bluepieapps/btpassword.py
"""
